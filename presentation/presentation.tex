        ...
        \begin{center}
            \begin{minipage}[h]{0.97\linewidth}
                ...
                \begin{equation}\label{eq:math_task}
                    ...
                    \end{gathered}
                \end{equation}
                Оптимальность (\ref{eq:harmonic_sum}) доказана следующей теоремой:
            ...
            \end{minipage}
        \end{center}
        \footnotetext[3]{\label{foot-3} Костин В. А., Костин Д. В., Сапронов Ю. И. Многочлены Максвелла"=Фейера
        и оптимизация полигармонических импульсов // ДАН. — М., 2012.}
    \end{frame}
